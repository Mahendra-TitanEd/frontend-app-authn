...
export default defineMessages({
  checkboxLabel: {
    ...
    description: 'Custom login — pilot participation confirmation checkbox label',
  },
  termsLink: {
    id: 'LOGIN.PILOT_TERMS_LINK',
    defaultMessage: 'Terms of Use and Confidentiality Notice',
    description: 'Custom login — link text opening pilot terms popup',
  },
  requiredError: {
    id: 'LOGIN.PILOT_TERMS_REQUIRED',
    defaultMessage: 'You must confirm the pilot terms before signing in.',
    description: 'Custom login — validation when pilot terms checkbox is unchecked',
  },
  dialogTitle: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_TITLE',
    defaultMessage: 'SEARN NRA Learning Space Pilot – Terms of Use and Confidentiality Notice',
    description: 'Custom login — pilot terms popup title',
  },
  dialogParagraph1: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P1',
    ...
    description: 'Custom login — pilot terms popup paragraph 1',
  },
  dialogParagraph2: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P2',
    ...
    description: 'Custom login — pilot terms popup paragraph 2',
  },
  dialogParagraph3: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P3',
    ...
    description: 'Custom login — pilot terms popup paragraph 3',
  },
  dialogParagraph4: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P4',
    ...
    description: 'Custom login — pilot terms popup paragraph 4',
  },
  dialogParagraph5: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P5',
    ...
    description: 'Custom login — pilot terms popup paragraph 5',
  },
  dialogParagraph6: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_P6',
    ...
    description: 'Custom login — pilot terms popup paragraph 6',
  },
  dialogOk: {
    id: 'LOGIN.PILOT_TERMS_DIALOG_OK',
    defaultMessage: 'OK',
    description: 'Custom login — pilot terms popup dismiss button',
  },
});
